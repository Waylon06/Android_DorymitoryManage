...
public class TeacherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listView = findViewById(R.id.stuDoryInfo);
        listView.setAdapter(new DoryStudentAdapter(data, this));
...
//                    students = studentDao.selectStudentByRole(role, query);
                ...
                listView.setAdapter(new DoryStudentAdapter(students, TeacherActivity.this));
                System.out.println(students);
//                data = students;
//                ArrayAdapter adapter = new ArrayAdapter (TeacherActivity.this, android.R.layout.simple_list_item_1, data);
